...
const checkWinner = (target) => { // target은 9개의 td 중 하나
  const rowIndex = target.parentNode.rowIndex; // 여기서 parentNode는 tr
  ...
  return hasWinner; // 승자가 있으면 true를 return, 승자가 없으면 false를 return
}
